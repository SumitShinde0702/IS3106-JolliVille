...
function FeatureCard({
  ...
  return (
    ...
    >
      <div
        className={`text-5xl mb-6 bg-gradient-to-r ${gradient} w-16 h-16 rounded-xl flex items-center justify-center text-white shadow-lg`}
      >
        {icon}
      </div>
...
export default withUserOnly(Home);
