...
const initialItems: ShopItem[] = [
  // Houses
  { id: 'house-1', name: 'House 1', image: '/village-items/houses/1.png', category: 'houses', price: 100, description: 'A cozy starter home', isStarter: true },
  { id: 'house-2', name: 'House 2', image: '/village-items/houses/2.png', category: 'houses', price: 150, description: 'A spacious family home', isStarter: true },
  { id: 'house-3', name: 'House 3', image: '/village-items/houses/3.png', category: 'houses', price: 200, description: 'A luxurious mansion' },
  { id: 'house-4', name: 'House 4', image: '/village-items/houses/4.png', category: 'houses', price: 250, description: 'A grand estate' },
  
  // Tents
  { id: 'tent-1', name: 'Tent 1', image: '/village-items/tents/1.png', category: 'tents', price: 50, description: 'A simple camping tent', isStarter: true },
  { id: 'tent-2', name: 'Tent 2', image: '/village-items/tents/2.png', category: 'tents', price: 75, description: 'A comfortable tent' },
  { id: 'tent-3', name: 'Tent 3', image: '/village-items/tents/3.png', category: 'tents', price: 100, description: 'A deluxe tent' },
  { id: 'tent-4', name: 'Tent 4', image: '/village-items/tents/4.png', category: 'tents', price: 125, description: 'A luxury tent' },
  
  // Decor
  { id: 'decor-1', name: 'Decor 1', image: '/village-items/decor/1.png', category: 'decor', price: 25, description: 'A decorative item', isStarter: true },
  { id: 'decor-2', name: 'Decor 2', image: '/village-items/decor/2.png', category: 'decor', price: 30, description: 'A decorative item' },
  { id: 'decor-3', name: 'Decor 3', image: '/village-items/decor/3.png', category: 'decor', price: 35, description: 'A decorative item' },
  { id: 'decor-4', name: 'Decor 4', image: '/village-items/decor/4.png', category: 'decor', price: 40, description: 'A decorative item' },
  { id: 'decor-5', name: 'Decor 5', image: '/village-items/decor/5.png', category: 'decor', price: 45, description: 'A decorative item' },
  { id: 'decor-6', name: 'Decor 6', image: '/village-items/decor/6.png', category: 'decor', price: 50, description: 'A decorative item' },
  { id: 'decor-7', name: 'Decor 7', image: '/village-items/decor/7.png', category: 'decor', price: 55, description: 'A decorative item' },
  { id: 'decor-8', name: 'Decor 8', image: '/village-items/decor/8.png', category: 'decor', price: 60, description: 'A decorative item' },
  { id: 'decor-9', name: 'Decor 9', image: '/village-items/decor/9.png', category: 'decor', price: 65, description: 'A decorative item' },
  { id: 'decor-10', name: 'Decor 10', image: '/village-items/decor/10.png', category: 'decor', price: 70, description: 'A decorative item' },
  { id: 'decor-11', name: 'Decor 11', image: '/village-items/decor/11.png', category: 'decor', price: 75, description: 'A decorative item' },
  { id: 'decor-12', name: 'Decor 12', image: '/village-items/decor/12.png', category: 'decor', price: 80, description: 'A decorative item' },
  { id: 'decor-13', name: 'Decor 13', image: '/village-items/decor/13.png', category: 'decor', price: 85, description: 'A decorative item' },
  { id: 'decor-14', name: 'Decor 14', image: '/village-items/decor/14.png', category: 'decor', price: 90, description: 'A decorative item' },
  { id: 'decor-15', name: 'Decor 15', image: '/village-items/decor/15.png', category: 'decor', price: 95, description: 'A decorative item' },
  { id: 'decor-16', name: 'Decor 16', image: '/village-items/decor/16.png', category: 'decor', price: 100, description: 'A decorative item' },
  { id: 'decor-17', name: 'Decor 17', image: '/village-items/decor/17.png', category: 'decor', price: 105, description: 'A decorative item' }
]

export default function ShopPage() {
  const [items, setItems] = useState<ShopItem[]>(initialItems)
  const [selectedCategory, setSelectedCategory] = useState<'houses' | 'tents' | 'decor' | 'bundles'>('houses')
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 p-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {(['houses', 'tents', 'decor', 'bundles'] as const).map((category) => (
            <button
              key={category}
