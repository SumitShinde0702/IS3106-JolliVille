...
const initialItems: ShopItem[] = [
  ...
  { id: 'house-1', name: 'Noble Manor', image: '/village-items/houses/1.png', category: 'houses', price: 100, description: 'A prestigious noble estate', isStarter: true },
  { id: 'house-2', name: 'Cozy Cabin', image: '/village-items/houses/2.png', category: 'houses', price: 150, description: 'A comfortable family home', isStarter: true },
  { id: 'house-3', name: 'Modest House', image: '/village-items/houses/3.png', category: 'houses', price: 200, description: 'A simple but elegant residence' },
  { id: 'house-4', name: 'Charming Home', image: '/village-items/houses/4.png', category: 'houses', price: 250, description: 'A quaint and lovely dwelling' },
  { id: 'house-5', name: 'Elegant Manor', image: '/village-items/houses/5.png', category: 'houses', price: 300, description: 'A refined and sophisticated home' },
  { id: 'house-6', name: 'Grand Estate', image: '/village-items/houses/6.png', category: 'houses', price: 350, description: 'A magnificent family estate' },
  { id: 'house-7', name: 'Royal Palace', image: '/village-items/houses/7.png', category: 'houses', price: 400, description: 'A majestic royal residence' },
  { id: 'house-8', name: 'Simple Cottage', image: '/village-items/houses/8.png', category: 'houses', price: 450, description: 'A humble dwelling' },
  { id: 'house-9', name: 'Imperial Castle', image: '/village-items/houses/9.png', category: 'houses', price: 500, description: 'A grand imperial fortress' },
  { id: 'house-10', name: 'Royal Castle', image: '/village-items/houses/10.png', category: 'houses', price: 550, description: 'A splendid royal castle' },
  { id: 'house-11', name: 'Imperial Palace', image: '/village-items/houses/11.png', category: 'houses', price: 600, description: 'An imperial palace of grandeur' },
  { id: 'house-12', name: 'Royal Fortress', image: '/village-items/houses/12.png', category: 'houses', price: 650, description: 'A fortified royal residence' },
  { id: 'house-13', name: 'Mystical Castle', image: '/village-items/houses/13.png', category: 'houses', price: 700, description: 'A castle shrouded in mystery' },
  { id: 'house-14', name: 'Enchanted Palace', image: '/village-items/houses/14.png', category: 'houses', price: 750, description: 'A palace touched by magic' },
  { id: 'house-15', name: 'Mystical Manor', image: '/village-items/houses/15.png', category: 'houses', price: 800, description: 'A manor of mystical power' },
  { id: 'house-16', name: 'Legendary Castle', image: '/village-items/houses/16.png', category: 'houses', price: 850, description: 'A castle of legendary renown' },
  { id: 'house-17', name: 'Ancient Citadel', image: '/village-items/houses/17.png', category: 'houses', price: 900, description: 'An ancient fortified city' },
  { id: 'house-18', name: 'Divine Palace', image: '/village-items/houses/18.png', category: 'houses', price: 950, description: 'A palace blessed by the gods' },
  { id: 'house-19', name: 'Celestial Castle', image: '/village-items/houses/19.png', category: 'houses', price: 1000, description: 'A castle from the heavens' },
  { id: 'house-20', name: 'Ethereal Mansion', image: '/village-items/houses/20.png', category: 'houses', price: 1050, description: 'A mansion of ethereal beauty' },
  { id: 'house-21', name: 'Mythical Palace', image: '/village-items/houses/21.png', category: 'houses', price: 1100, description: 'A palace from myths' },
  { id: 'house-22', name: 'Legendary Citadel', image: '/village-items/houses/22.png', category: 'houses', price: 1150, description: 'A citadel of legends' },
  { id: 'house-23', name: 'Celestial Palace', image: '/village-items/houses/23.png', category: 'houses', price: 1200, description: 'A palace from the stars' },
  { id: 'house-24', name: 'Ethereal Castle', image: '/village-items/houses/24.png', category: 'houses', price: 1250, description: 'A castle of ethereal grace' },
  { id: 'house-25', name: 'Mythical Fortress', image: '/village-items/houses/25.png', category: 'houses', price: 1300, description: 'A fortress from myths' },
  { id: 'house-26', name: 'Divine Citadel', image: '/village-items/houses/26.png', category: 'houses', price: 1350, description: 'A citadel blessed by divinity' },
  { id: 'house-27', name: 'Legendary Palace', image: '/village-items/houses/27.png', category: 'houses', price: 1400, description: 'A palace of legendary status' },
  
  // Tents - Based on size and complexity
  { id: 'tent-1', name: 'Basic Tent', image: '/village-items/tents/1.png', category: 'tents', price: 50, description: 'A simple camping tent', isStarter: true },
  { id: 'tent-2', name: 'Comfortable Tent', image: '/village-items/tents/2.png', category: 'tents', price: 75, description: 'A cozy camping tent' },
  { id: 'tent-3', name: 'Deluxe Tent', image: '/village-items/tents/3.png', category: 'tents', price: 100, description: 'A spacious camping tent' },
  { id: 'tent-4', name: 'Luxury Tent', image: '/village-items/tents/4.png', category: 'tents', price: 125, description: 'A luxurious camping tent' },
  { id: 'tent-5', name: 'Premium Tent', image: '/village-items/tents/5.png', category: 'tents', price: 150, description: 'A premium camping tent' },
  { id: 'tent-6', name: 'Elite Tent', image: '/village-items/tents/6.png', category: 'tents', price: 175, description: 'An elite camping tent' },
  
  // Archer Towers - Based on defensive capabilities
  { id: 'tower-1', name: 'Basic Tower', image: '/village-items/archer-towers/1.png', category: 'archer-towers', price: 200, description: 'A simple defensive tower', isStarter: true },
  { id: 'tower-2', name: 'Improved Tower', image: '/village-items/archer-towers/2.png', category: 'archer-towers', price: 300, description: 'An enhanced defensive tower' },
  { id: 'tower-4', name: 'Advanced Tower', image: '/village-items/archer-towers/4.png', category: 'archer-towers', price: 400, description: 'A sophisticated defensive tower' },
...
export default function ShopPage() {
  ...
  const loadOwnedItems = async (userId: string) => {
    try {
      ...
      const ownedItemIds = new Set<string>(ownedItemsData.map(item => item.item_id))
  ...
  useEffect(() => {
    const generateBundle = () => {
      ...
      for (let i = 0; i < numItems; i++) {
        const available = availableItems.filter(item => !usedIds.has(item.id))
  ...
  const handleSell = async (item: ShopItem) => {
    ...
    try {
      ...
      if (placedItems && placedItems.length > 0) {
        if (!confirm(`This item is currently placed in your village. If you sell it, it will be removed from your village layout. Do you want to proceed?`)) {
          return
        }
        ...
        if (!confirm(`Are you sure you want to sell ${item.name} for ${Math.round(item.price * 0.8)} points?`)) {
          return
        }
      }
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="bg-white rounded-lg shadow-lg p-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`text-2xl font-bold ${pointsChange ? 'animate-pulse' : ''}`}>
              {points}
              {pointsChange && (
                <span className={`ml-2 ${pointsChange > 0 ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <div>
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  className="rounded"
                />
                <span className="text-sm text-gray-600">Show only owned items</span>
              </label>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          {selectedCategory === 'bundles' ? (
            currentBundle ? (
              <div className="bg-white rounded-lg shadow-lg p-4">
                <h3 className="text-xl font-semibold mb-4">{currentBundle.name}</h3>
                <div className="mb-4">
                  <div className="text-sm text-gray-600">Expires in:</div>
                  <div className="text-lg font-semibold text-pink-600">
                    {Math.floor((currentBundle.expiresAt.getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24))} days
                  </div>
                </div>
                  ...
                  {currentBundle.items.map(item => (
                    <div key={item.id} className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">{item.price} points</div>
                      </div>
                    </div>
                  ))}
                </div>
                <div className="mt-4 pt-4 border-t">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-lg font-semibold">{currentBundle.totalPrice} points</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Bundle Price:</span>
                    <span className="text-xl font-bold text-green-600">{currentBundle.discountedPrice} points</span>
                  </div>
                  <div className="text-sm text-gray-600 mt-2">
                    Save {currentBundle.totalPrice - currentBundle.discountedPrice} points!
                  </div>
                </div>
                <button
                  onClick={() => {
              ...
              <div className="col-span-full text-center py-8">
                <div className="text-xl font-semibold mb-2">No Active Bundle</div>
                <div className="text-gray-600">Check back next week for new bundles!</div>
              </div>
            )
          ) : (
            filteredItems.map(item => (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <div className="text-xl font-bold text-pink-600">{item.price} points</div>
                  {ownedItems.has(item.id) ? (
                    <button
                    ...
                    >
                      {item.isStarter ? 'Starter Item' : `Sell (${Math.round(item.price * 0.8)} points)`}
                    </button>
                  ) : (
                    <button
          ...
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="text-lg font-semibold mb-2">{selectedItem.price} points</div>
                <p className="text-gray-600 mb-4">{selectedItem.description}</p>
                {ownedItems.has(selectedItem.id) && (
                  <div className="mb-4">
                    <div className="text-sm text-gray-600 mb-2">Selling Instructions:</div>
                    <ol className="list-decimal list-inside text-sm text-gray-600 space-y-1">
                      <li>Click the "Sell" button below</li>
                      <li>Confirm the sale in the popup dialog</li>
                      <li>You will receive 80% of the original price ({Math.round(selectedItem.price * 0.8)} points)</li>
                    </ol>
                  </div>
                )}
              </div>
